...
const CODE_MESSAGES: Record<string, string> = {
  ...
  AI_UNAVAILABLE: "تحليل المعرفة غير متاح حالياً. حاول لاحقاً.",
  AI_TIMEOUT: "استغرق التحليل وقتاً أطول من المتوقع. حاول مرة أخرى بنص أقصر.",
  AI_FAILED: "تعذر تحليل المعلومات الآن. حاول مرة أخرى.",
  INPUT_TOO_LONG: "النص أطول من الحد المسموح. اختصر ثم أعد المحاولة.",
  TOO_MANY_FACTS:
    "المعلومات كثيرة جداً دفعة واحدة. قسّم النص على أكثر من مرة ثم أعد التحليل.",
  STALE_PROPOSAL: "تغيرت المعرفة الحالية. أعد التحليل ثم اعتمد من جديد.",
  UNRESOLVED_CONFLICT: "هناك تعارضات تحتاج اختيارك قبل الاعتماد.",
  EMPTY_INPUT: "اكتب أو الصق معلومات النشاط أولاً.",

...
const howSteps = [
  ...
  },
  {
    ...
    body: "امسح رمز QR، فعّل الوكيل، ودع المنصة ترد على الرسائل الجديدة — مع إمكانية الرد اليدوي في أي وقت.",
  },
];
...
const faqItems = [
  {
    ...
    a: "نعم. الواجهة عربية أولاً مع دعم RTL، ويمكن ضبط لغة ولهجة الوكيل.",
  },
  {
    ...
    <div className="flex min-h-full flex-col">
      ...
      <main className="flex-1">
        ...
        <LandingSection
          ...
          description="تفعيل/إيقاف الرد الآلي، حدود الخطة، وحماية من السباقات بين الموظف والوكيل. لسنا شريكاً رسمياً لواتساب ولا نضمن عدم قيود المنصة."
        />
          ...
          <div className="mx-auto max-w-6xl px-4 sm:px-6">
            <div className="rounded-2xl border border-border bg-[linear-gradient(120deg,#0b1f26,#134e4a)] px-6 py-12 text-sidebar-foreground shadow-md sm:px-10">
              ...
              <p className="mt-3 max-w-xl text-sm leading-7 text-sidebar-muted sm:text-base">
                أنشئ حسابك، اربط واتساب، درّب الوكيل — وابدأ استقبال العملاء اليوم.
              </p>
              <div className="mt-6">
                <Link href="/signup">
                  <Button
